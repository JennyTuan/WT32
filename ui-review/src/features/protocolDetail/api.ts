    ...
    if (seriesType === "topogram") {
        return {
            ...
            topogram_param: {
                ...
                fov: 500,
                collimator: "32*0.6",
                focus_size: "small", bowtie_type: "medium",
        ...
        series: scanSession.series.map((series) => ({
            ...
            topogram_param: series.topogram_param
                ? {
                    ...
                    focus_size: series.topogram_param.focus_size,
                    bowtie_type: series.topogram_param.bowtie_type,
            ...
            helical_param: series.helical_param
                ? {
                    ...
                    focus_size: series.helical_param.focus_size,
                    bowtie_type: series.helical_param.bowtie_type,
            ...
            axial_param: series.axial_param
                ? {
                    ...
                    focus_size: series.axial_param.focus_size,
                    bowtie_type: series.axial_param.bowtie_type,

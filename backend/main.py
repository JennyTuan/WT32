...
from .routers import contrast_configs, corners, disk_manager, dom_configs, patients, protocols, recon_params, scan_params, scan_sessions
...
app.include_router(dom_configs.router, prefix="/api")
